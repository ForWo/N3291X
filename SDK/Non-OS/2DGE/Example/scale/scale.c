 ...
 *
 *  This sample program shows the usage of N3291x Stretch BLT functions. 
 *                                                             
 ******************************************************************************/
#include "wblib.h"
...
{
    #include "../shu_320x240_RGB565.dat"
};
...
INT main()
{
    ...
    gfx_env_info.nSrcWidth              = IMAGE_WIDTH;
    gfx_env_info.nSrcHeight             = IMAGE_HEIGHT;
    gfx_env_info.nSrcPitch              = IMAGE_WIDTH * 2; 
    ...
    gfx_env_info.uSrcStartAddr          = (UINT32)ImageData;
...
{   
    ...
    dest_rect.fC.nTop = 0;
    dest_rect.fC.nRight = IMAGE_WIDTH - 1;
    dest_rect.fC.nBottom = IMAGE_HEIGHT - 1;
    ...
    gfxStretchImage(src_rect, dest_rect);   

    delay(100);    
   
#if 1 // stretch image to full screen  
    ...
    while (r < LCM_WIDTH)
    {
        dest_rect.fC.nLeft = 0;
        dest_rect.fC.nTop = 0;
        dest_rect.fC.nRight = r;
        dest_rect.fC.nBottom = b;
