 ...
 *
 *  This sample program shows the usage of N3291x BitBLT functions. 
 *                                                             
 ******************************************************************************/
#include "wblib.h"
...
INT main()
{
    ...
    while (1)
    {
        ...
        src_surface.uStartAddr = (UINT32)ImageData;
        ...
        gfxSetWriteMask(gfxMakeColor(COLOR_RED));
        gfxPutImage(src_rect, dest_pnt);

        delay(50);

        gfxSetWriteMask(gfxMakeColor(COLOR_GREEN));
        gfxPutImage(src_rect, dest_pnt);

        delay(50);
        
        gfxSetWriteMask(gfxMakeColor(COLOR_BLUE));
        gfxPutImage(src_rect, dest_pnt);
        
        gfxSetWriteMask(gfxMakeColor(COLOR_WHITE));
