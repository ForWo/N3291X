...
#define OPT_LCM_TYPE    SAMSUNG_18
...
#else // new change 2005-03-27
  LCDWriteCMDAddrWORD(0x13);	
  LCDWriteCMDRegWORD(0x371f);	
  LCDWriteCMDAddrWORD(0x11);	
  LCDWriteCMDRegWORD(0x0217);	
  LCDWriteCMDAddrWORD(0x10);	
  LCDWriteCMDRegWORD(0x0110);	
  LCDWriteCMDAddrWORD(0x12);	
  //LCDWriteCMDRegWORD(0x3f19);	
  LCDWriteCMDRegWORD(0x3f1e);	
#endif  
  delay_long(12000);
