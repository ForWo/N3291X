 ...
 *                                                                                                                    
 *  DESCRIPTION
 *      This is module is used to draw solid lines on to screen.      
 * 
 *  HISTORY
 *      2014/12/01  Created.
 *
...
//
//  DESCRIPTION
//      This function is used to draw solid lines onto the destination 
//      surface.
//
//      This function is a subset of gfxDrawLine(). This function doesn't 
//      need to call gfxSetPen(). 
//
//  INPUTS
...
// 
///////////////////////////////////////////////////////////////////////////////
INT gfxDrawSolidLine(GFX_PNT_T p1, GFX_PNT_T p2, GFX_ENTRY color)
{
...
#if 0 // not necessary for solid line drawing
    ...
    /* use foreground color only */
    
    outpw(REG_2D_GEFC, color);
    ...
    line_control_code = 0x0000ffff; // solid line style
