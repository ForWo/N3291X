 ...
 *                                                                                                                    
 *  DESCRIPTION
 *      This module is used to handle the Host Read BLT operation.       
 * 
 *  HISTORY
 *      2014/12/01  Created.
 *
...
//
//  DESCRIPTION
//      This function is used to do the Host Read BLT.
//
//  INPUTS
//      src_rect:   source rectangle image to be copied to the destination buffer
//      dest_buf:   pointer to destination buffer 
//      
//  OUTPUTS
//      None
//
...
//
///////////////////////////////////////////////////////////////////////////////
INT gfxHostReadBlt(GFX_RECT_T src_rect, PVOID dest_buf)
{
    INT i, j; 
    UINT32 srcx, srcy, width, height;
    UINT32 cmd32, src_pitch, pitch, src_start, dimension;
    UINT32 data32, alpha;
    PUINT32 ptr32; 
    ...
    cmd32 = 0xcc430001; // only 0xCC is allowed 
    
    outpw(REG_2D_GECMD, cmd32); 
  
    src_pitch = (UINT32)(_gfx_nDestPitch / _gfx_nByte); // pitch in pixels
    pitch = src_pitch << 16 | src_pitch; 
    outpw(REG_2D_GESDP, pitch);

    src_start = srcy << 16 | srcx;
    outpw(REG_2D_GEDSXYL, src_start);
