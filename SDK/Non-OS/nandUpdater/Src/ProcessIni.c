...
int ProcessINI(char *fileName)
{
    ...
    Ini_Writer.NAND1_1_FAT = 1;
    Ini_Writer.NAND1_2_FAT = 1;
...
NextMark2:
        if (strcmp(Cmd, "[NandLoader File Name]") == 0)
        {
            do {
                ...
                else
                {
                    if (strlen(Cmd) > 31)
                    {
                        sysprintf("ERROR: NandLoader File Name too long !! It must < 32 !!\n");
                        return -1;
                    }
        ...
        else if (strcmp(Cmd, "[Logo File Name]") == 0)
        {
            do {
                ...
                else
                {
                    if (strlen(Cmd) > 31)
                    {
                        sysprintf("ERROR: Logo File Name too long !! It must < 32 !!\n");
                        return -1;
                    }
        ...
        else if (strcmp(Cmd, "[NVTLoader File Name]") == 0)
        {
            do {
                ...
                else
                {
                    if (strlen(Cmd) > 31)
                    {
                        sysprintf("ERROR: NVTLoader File Name too long !! It must < 32 !!\n");
                        return -1;
                    }
	...
	dbgprintf("**Process NandWriter.ini file**\n");
