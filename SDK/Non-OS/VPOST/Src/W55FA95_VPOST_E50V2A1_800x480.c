...
#if defined(HAVE_E50V2A1_800x480)
...
void E50V2A1_800x480_Init(void)
{
...
INT vpostLCMInit_E50V2A1_800x480(PLCDFORMATEX plcdformatex, UINT32 *pFramebuf)
{
...
INT32 vpostLCMDeinit_E50V2A1_800x480(VOID)
{
	vpostVAStopTrigger();
	vpostFreeVABuffer();
