...
#if defined(HAVE_KD070D10_800x480)
...
void KD070D10_800x480_Init(void)
{
...
INT vpostLCMInit_KD070D10_800x480(PLCDFORMATEX plcdformatex, UINT32 *pFramebuf)
{
	volatile S_DRVVPOST_SYNCLCM_WINDOW sWindow = {800,480,800};	
	volatile S_DRVVPOST_SYNCLCM_HTIMING sHTiming = {3,45,(UINT8)210};
	volatile S_DRVVPOST_SYNCLCM_VTIMING sVTiming = {3,22,23};
...
INT32 vpostLCMDeinit_KD070D10_800x480(VOID)
{
	vpostVAStopTrigger();
	vpostFreeVABuffer();
