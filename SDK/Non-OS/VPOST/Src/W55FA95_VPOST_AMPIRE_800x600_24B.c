 ...
 * 
 * FILENAME
 *     FA93_VPOST_AMPIRE_800x600_24B.c
 *
 * VERSION
 *     0.1 
 *
...
#if defined(HAVE_AMPIRE_800x600_24B)
...
void AMPIRE_800x600_24B_nit(void)
{
...
INT vpostLCMInit_AMPIRE_800x600_24B(PLCDFORMATEX plcdformatex, UINT32 *pFramebuf)
{
	volatile S_DRVVPOST_SYNCLCM_WINDOW sWindow = {800,600,800};	
//	volatile S_DRVVPOST_SYNCLCM_HTIMING sHTiming = {10,66,(UINT8)210};
//	volatile S_DRVVPOST_SYNCLCM_HTIMING sHTiming = {0x93,0xDE,(UINT8)0x16};
...
#define OPT_24BIT_MODE
	...
	//	else if (u32PLLclk == 360)	// 36.0 = 360/2/5
	//	{		
	//		u32Clkin = 1;
	//		u32ClockDivider = 4;
	//	}			
...
INT32 vpostLCMDeinit_AMPIRE_800x600_24B(VOID)
{
	vpostVAStopTrigger();
	vpostFreeVABuffer();
