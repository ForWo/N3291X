...
#if defined(HAVE_AMPIRE_800x600)
...
INT vpostLCMInit_AMPIRE_800x600(PLCDFORMATEX plcdformatex, UINT32 *pFramebuf)
{
...
INT32 vpostLCMDeinit_AMPIRE_800x600(VOID)
{
	vpostVAStopTrigger();
	vpostFreeVABuffer();
