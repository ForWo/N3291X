...
int DemoAPI_AIC(void)
{
	...
	{	
		sysInstallISR(u32IntTypeLevel, 0, (PVOID)Int_Channel_0);
		sysInstallISR(u32IntTypeLevel, 1, (PVOID)Int_Channel_1);
		sysInstallISR(u32IntTypeLevel, 2, (PVOID)Int_Channel_2);
		sysInstallISR(u32IntTypeLevel, 3, (PVOID)Int_Channel_3);
		sysInstallISR(u32IntTypeLevel, 4, (PVOID)Int_Channel_4);
		sysInstallISR(u32IntTypeLevel, 5, (PVOID)Int_Channel_5);
		sysInstallISR(u32IntTypeLevel, 6, (PVOID)Int_Channel_6);
		sysInstallISR(u32IntTypeLevel, 7, (PVOID)Int_Channel_7);
		sysInstallISR(u32IntTypeLevel, 8, (PVOID)Int_Channel_8);
		sysInstallISR(u32IntTypeLevel, 9, (PVOID)Int_Channel_9);
		sysInstallISR(u32IntTypeLevel, 10, (PVOID)Int_Channel_10);
		sysInstallISR(u32IntTypeLevel, 11, (PVOID)Int_Channel_11);
		sysInstallISR(u32IntTypeLevel, 12, (PVOID)Int_Channel_12);
		sysInstallISR(u32IntTypeLevel, 13, (PVOID)Int_Channel_13);
		sysInstallISR(u32IntTypeLevel, 14, (PVOID)Int_Channel_14);
		sysInstallISR(u32IntTypeLevel, 15, (PVOID)Int_Channel_15);
		sysInstallISR(u32IntTypeLevel, 16, (PVOID)Int_Channel_16);
		sysInstallISR(u32IntTypeLevel, 17, (PVOID)Int_Channel_17);
		sysInstallISR(u32IntTypeLevel, 18, (PVOID)Int_Channel_18);
		sysInstallISR(u32IntTypeLevel, 19, (PVOID)Int_Channel_19);
		sysInstallISR(u32IntTypeLevel, 20, (PVOID)Int_Channel_20);
		sysInstallISR(u32IntTypeLevel, 21, (PVOID)Int_Channel_21);
		sysInstallISR(u32IntTypeLevel, 22, (PVOID)Int_Channel_22);
		sysInstallISR(u32IntTypeLevel, 23, (PVOID)Int_Channel_23);
		sysInstallISR(u32IntTypeLevel, 24, (PVOID)Int_Channel_24);
		sysInstallISR(u32IntTypeLevel, 25, (PVOID)Int_Channel_25);
		sysInstallISR(u32IntTypeLevel, 26, (PVOID)Int_Channel_26);
		sysInstallISR(u32IntTypeLevel, 27, (PVOID)Int_Channel_27);
		sysInstallISR(u32IntTypeLevel, 28, (PVOID)Int_Channel_28);
		sysInstallISR(u32IntTypeLevel, 29, (PVOID)Int_Channel_29);
		sysInstallISR(u32IntTypeLevel, 30, (PVOID)Int_Channel_30);
		sysInstallISR(u32IntTypeLevel, 31, (PVOID)Int_Channel_31);	
		sysSetLocalInterrupt(DISABLE_FIQ_IRQ);		
				
		for(u32Idx=0;u32Idx<32;u32Idx=u32Idx+1)
		{
		    /* Only Rising edge and falling edge can be teset */		
			sysEnableInterrupt(u32Idx);
			if(u32IntTypeLevel%2)
				sysSetInterruptType(u32Idx, 2);//Falling
			else
				sysSetInterruptType(u32Idx, 3);//Rising		
		}		
