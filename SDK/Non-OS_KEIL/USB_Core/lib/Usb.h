...
#define HOST_LIKE_PORT0_0			2
#define HOST_LIKE_PORT0_1			3	
#define HOST_LIKE_PORT0_2			4
#define HOST_LIKE_PORT0_3			5
#define HOST_LIKE_PORT1_DISABLE			0xFF	
#define HOST_LIKE_PORT0_DISABLE			0xFF	
#endif
...
#else
extern void USB_PortInit(UINT32 u32Port1, UINT32 u32Port0);
#endif

extern VOID USB_PortDisable(BOOL bIsDisPort1, BOOL bIsDisPort0);
