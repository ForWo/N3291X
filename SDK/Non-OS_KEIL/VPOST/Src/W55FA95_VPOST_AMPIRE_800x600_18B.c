 ...
 * 
 * FILENAME
 *     FA93_VPOST_AMPIRE_800x600_18B.c
 *
 * VERSION
 *     0.1 
 *
...
#if defined(HAVE_AMPIRE_800x600_18B)
...
void AMPIRE_800x600_18B_nit(void)
{
...
INT vpostLCMInit_AMPIRE_800x600_18B(PLCDFORMATEX plcdformatex, UINT32 *pFramebuf)
{
...
INT32 vpostLCMDeinit_AMPIRE_800x600_18B(VOID)
{
	vpostVAStopTrigger();
	vpostFreeVABuffer();
