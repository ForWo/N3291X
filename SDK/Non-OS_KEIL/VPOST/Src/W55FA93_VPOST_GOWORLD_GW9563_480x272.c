...
INT vpostLCMInit_GOWORLD_GWTFM9563B(PLCDFORMATEX plcdformatex, UINT32 *pFramebuf)
{
//	volatile S_DRVVPOST_SYNCLCM_WINDOW sWindow = {480,272,480};	
	volatile S_DRVVPOST_SYNCLCM_WINDOW sWindow = {480,272,480};
//	volatile S_DRVVPOST_SYNCLCM_HTIMING sHTiming = {2,0x28,(UINT8)0x33};	// H-pulse width, H-backporch, H-Frontporch
//	volatile S_DRVVPOST_SYNCLCM_HTIMING sHTiming = {2,0x24,(UINT8)0x33};
//	volatile S_DRVVPOST_SYNCLCM_HTIMING sHTiming = {2,0x28,(UINT8)0x05};
	volatile S_DRVVPOST_SYNCLCM_HTIMING sHTiming = {59,0x28,(UINT8)0x05};
//	volatile S_DRVVPOST_SYNCLCM_VTIMING sVTiming = {3,0x8,8};				// V-pulse width, V-Backportch, H-Frontporch
//	volatile S_DRVVPOST_SYNCLCM_VTIMING sVTiming = {3,0x8,0x28};
	volatile S_DRVVPOST_SYNCLCM_VTIMING sVTiming = {3,0x8,0x8};
...
//	u32ClockDivider--;
	...
	u32ClockDivider = u32PLLclk / u32Clkin / 9000000 - 1;
	u32Clkin--;
...
INT vpostLCMDeinit_GOWORLD_GWTFM9563B(void)
{
	vpostVAStopTrigger();
	vpostFreeVABuffer();
