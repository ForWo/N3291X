...
#if defined(HAVE_AMPIRE_800x480_18B)
...
//	volatile S_DRVVPOST_SYNCLCM_HTIMING sHTiming = {10,66,(UINT8)210};
	volatile S_DRVVPOST_SYNCLCM_HTIMING sHTiming = {10,00,(UINT8)210};
...
//	AMPIRE_800x480_18B_Init();
	...
	outp32(REG_MISC_DS_GPE, 0x00000003);
